...
-- ============================================================
-- v8: AI Knowledge Base
-- ============================================================

-- Knowledge base articles (per-client or global when client_id IS NULL)
...
CREATE INDEX IF NOT EXISTS idx_kb_client     ON knowledge_base_articles(client_id);
CREATE INDEX IF NOT EXISTS idx_kb_category   ON knowledge_base_articles(category);
CREATE INDEX IF NOT EXISTS idx_kb_active     ON knowledge_base_articles(is_active);
-- Full-text search index on title + content
CREATE INDEX IF NOT EXISTS idx_kb_fts ON knowledge_base_articles
